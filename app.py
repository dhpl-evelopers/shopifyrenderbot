...
def show_chat_ui():
    ...
    if not st.session_state.get("messages"):
        ...
        for msg in st.session_state.get("messages", []):
            ...
            icon_html = (
                '<img src="https://cdn-icons-png.flaticon.com/512/1077/1077012.png" width="24" height="24"/>'
                if msg["role"] == "user"
                else '<img src="https://cdn-icons-png.flaticon.com/512/4712/4712027.png" width="24" height="24"/>'
            )

            content_html = f"""
            <div class="{role_class}-wrapper" style="display: flex; align-items: center; gap: 10px;">
                <div class="chat-icon">{icon_html}</div>
